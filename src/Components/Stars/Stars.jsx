...
const starPhases = [
    {
        ...
        image: "../../../public/../../../public/birth.avif",
        details: [
...
const starBackgrounds = {
    ...
    3: "url('../../../public/old-map.png'), linear-gradient(to bottom, #1a1a1a, #4c1d1d, #b56c6c)",
    4: "url('../../../public/old-map.png'), linear-gradient(to bottom, #2a2a2a, #6c1616, #d84d4d)",
    5: "url('../../../public/dark-denim.png'), linear-gradient(to bottom, #1a1a1a, #6f1d1d, #b95e5e)",
    6: "url('../../../public/snow.png'), linear-gradient(to bottom, #0a0a0a, #1f1f1f, #404040)",
    7: "url('../../../public/dark-denim.png'), linear-gradient(to bottom, #2e2e2e, #4e4e4e, #6c6c6c)",
    ...
    10: "url('../../../public/wood.png'), linear-gradient(to bottom, #1d1d1d, #3a3a3a, #595959)"
};
