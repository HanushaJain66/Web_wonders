...
const galaxies = [
    {
        ...
        starImage: '../../../public/images/milky.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/adro.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/m33.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/sombero.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/m51.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/pinwheel.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/cartwheel.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/m87.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/centurus.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/ngc1300.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/tadpole.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/anta.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/m81.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/ngc1309.jpg',
    ...
    },
    {
        ...
        starImage: 'i../../../public/mages/ngc6946.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/ngc4565.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/antanne.jpg',
        link: "https://en.wikipedia.org/wiki/Antennae_Galaxies"
    },
    {
        id: 18,
        ...
        starImage: '../../../public/images/hoags.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/spindle.jpg',
    ...
    },
    {
        ...
        starImage: '../../../public/images/ngc4921.jpg',
        link: "https://en.wikipedia.org/wiki/NGC_4921"
    }
];

const galaxyBackgrounds = {
    1: "url('../../../public/dark-denim.png'), linear-gradient(to bottom, #1a1a1a, #400000, #b22222)",
    2: "url('../../../public/dark-denim.png'), linear-gradient(to bottom, #0a0a0a, #3f0c0c, #a83f3f)",
    3: "url('../../../public/wood.png'), linear-gradient(to bottom, #1a1a1a, #4c1d1d, #b56c6c)",
    4: "url('../../../public/old-map.png'), linear-gradient(to bottom, #2a2a2a, #6c1616, #d84d4d)",
    5: "url('../../../public/old-map.png'), linear-gradient(to bottom, #1a1a1a, #6f1d1d, #b95e5e)",
    6: "url('../../../public/snow.png'), linear-gradient(to bottom, #0a0a0a, #1f1f1f, #404040)",
    7: "url('../../../public/wood.png'), linear-gradient(to bottom, #2e2e2e, #4e4e4e, #6c6c6c)",
    8: "url('../../../public/wood.png'), linear-gradient(to bottom, #1e1e1e, #3b3b3b, #585858)",
    9: "url('../../../public/paper.png'), linear-gradient(to bottom, #2c2c2c, #4a4a4a, #6d6d6d)",
    10: "url('../../../public/paper.png'), linear-gradient(to bottom, #1d1d1d, #3a3a3a, #595959)",
    11: "url('../../../public/asfalt-light.png'), linear-gradient(to bottom, #2a2a2a, #3c3c3c, #4e4e4e)",
    12: "url('../../../public/asfalt-light.png'), linear-gradient(to bottom, #1f1f1f, #3f3f3f, #5f5f5f)",
    13: "url('../../../public/paper.png'), linear-gradient(to bottom, #262626, #484848, #6a6a6a)",
    14: "url('../../../public/dark-fish-skin.png'), linear-gradient(to bottom, #1b1b1b, #353535, #4f4f4f)",
    15: "url('../../../public/dark-matter.png'), linear-gradient(to bottom, #2d2d2d, #4d4d4d, #6d6d6d)",
    16: "url('../../../public/dark-wall.png'), linear-gradient(to bottom, #1c1c1c, #3c3c3c, #5c5c5c)",
    17: "url('../../../public/dimension.png'), linear-gradient(to bottom, #292929, #4b4b4b, #6d6d6d)",
    18: "url('../../../public/dimension.png'), linear-gradient(to bottom, #191919, #383838, #575757)",
    19: "url('../../../public/dimension.png'), linear-gradient(to bottom, #2e2e2e, #4e4e4e, #6e6e6e)",
    20: "url('../../../public/gplay.png'), linear-gradient(to bottom, #1a1a1a, #3a3a3a, #5a5a5a)"
};
        ...
        <>
            ...
            <div className='cont-real'>
                <div className="video cont-video">
                    <video src='../../../public/galaxyvid.mp4' autoPlay muted playsInline loop>Unable to Play video</video>
